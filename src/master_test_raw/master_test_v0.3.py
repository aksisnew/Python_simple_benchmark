...
def rs(m):
    ts_config =[
        ("6_sort", t6, 10000000, 5000000, "elements sorted"),
        ("8_float", t8, 30000000, 15000000, "iterations"),
        ("9_json", t9, 500000, 250000, "json operations"),
        ("10_bst_regex", t10, 60000, 30000, "bst/regex operations"),
        ("11_division", t11, 50000000, 25000000, "iterations"),
        ("12_matrix_mult", t12, 4000, 2000, "matrix multiplications"),
        ("13_monte_carlo", t13, 10000000, 5000000, "simulations"),
        ("15_string_regex", t15, 100000, 50000, "regex operations")
    ]
    r = {}
    if m:
